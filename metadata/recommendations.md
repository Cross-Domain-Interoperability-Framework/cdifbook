...
2. A [JSON-LD serialization](./schemaOrgImplementationpatterns.md) for that content using the Schema.org vocabulary to define the fields in a metadata record, and an [implementation using the DCAT rdf vocabulary](./dcat.md)

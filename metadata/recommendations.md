...
CDIF metadata recommendations are packaged in a [set of profiles](https://cross-domain-interoperability-framework.github.io/cdifbook/preview-2026-05/background/structure/#summary-of-cdif-profiles-and-recommendations). Each profile includes:

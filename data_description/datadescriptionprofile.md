...
- item carries a different feature set depending on which CDIF profile a Dataset conforms to:
- @type  `schema:PropertyValue` + `cdi:InstanceVariable` 
- The InstanceVariable carries the value-domain links and all of the variable-level properties below. (`cdi:takesSentinelValuesFrom`, `cdi:takesSubstantiveValuesFrom`)

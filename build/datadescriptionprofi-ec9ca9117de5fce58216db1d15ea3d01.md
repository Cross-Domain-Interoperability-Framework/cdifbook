...
### cdif:statistics
- **Obligation:** Optional, Repeatable
- **JSON:** `"cdif:statistics": {cdi:Statistics} | {cdi:CategoryStatistics} | {or cdif:StatisticsCollection; inline} | {`@id`-reference}`
...
- **Obligation:** Optional, Repeatable
- **JSON:** `"cdif:physicalDataType": {DefinedTerm} | {skos:Concept} | {or string}`
...
- **Obligation:** Optional
- **JSON:** `"cdif:simpleUnitOfMeasure": "{string}" | {DefinedTerm} | {or skos:Concept}`
...
### cdif:uses
- **Obligation:** Optional, Repeatable
- **JSON:** `"cdif:uses": {DefinedTerm} | {skos:Concept} | {or string}`
...
### cdi:function
- **Obligation:** Optional, Repeatable
- **JSON:** `"cdi:function": {DefinedTerm} | {skos:Concept} | {or string}`
...
### cdi:platformType
- **Obligation:** Optional
- **JSON:** `"cdi:platformType": {DefinedTerm} | {skos:Concept} | {or string}`
...
- **Obligation:** Optional
- **JSON:** `"cdi:hasIntendedDataType": {xsdDataType} | {DefinedTerm} | {or skos:Concept}`
...
- **Obligation:** Optional
- **JSON:** `"cdi:describedUnitOfMeasure": {DefinedTerm} | {skos:Concept} | {or string}`
...
- **Obligation:** Optional, Repeatable
- **JSON:** `"cdi:takesSentinelValuesFrom": {cdif:SentinelValueDomain inline} | {or object reference}`
...
- **Obligation:** Optional
- **JSON:** `"cdi:takesSubstantiveValuesFrom": {cdif:SubstantiveValueDomain inline} | {or object reference}`
...
- **Obligation:** Optional
- **JSON:** `"cdif:takesValuesFrom": {cdif:EnumerationDomain inline} | {or object reference}`
...
### cdi:isDescribedBy
- **Obligation:** Optional
- **JSON:** `"cdi:isDescribedBy": {cdi:ValueAndConceptDescription inline} | {or object reference}`
...
### cdif:references
- **Obligation:** Optional
- **JSON:** `"cdif:references": {SKOS ConceptScheme inline} | {or object reference}`
...
### cdi:typeOfStatistic
- **Obligation:** Optional
- **JSON:** `"cdi:typeOfStatistic": {DefinedTerm} | {skos:Concept} | {or string}`
...
### cdi:for
- **Obligation:** Required
- **JSON:** `"cdi:for": {`cdi:Category` node (a concept-like node typed `cdi:Category`} | {carrying `cdif:name`/`cdif:definition`/`cdif:displayLabel`/`cdif:descriptiveText`)} | {or object reference}`

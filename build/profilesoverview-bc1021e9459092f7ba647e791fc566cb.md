...
#### Core profile artefacts: 
- **[CDIFCoreImplementationGuide.md](https://github.com/Cross-Domain-Interoperability-Framework/profile-core/blob/reviewRevision202606/CDIFCoreImplementationGuide.md)** — Documentation of all classes and properties for the CDIF Core profile, including required/optional properties, data types, and JSON-LD implementation guidance.
- **[cdifCoreStructuredSchema.json](https://github.com/Cross-Domain-Interoperability-Framework/profile-core/blob/reviewRevision202606/cdifCoreStructuredSchema.json)** — JSON Schema (Draft 2020-12) for validating CDIF Core profile instances. 
- **[coreRules.shacl](https://github.com/Cross-Domain-Interoperability-Framework/profile-core/blob/reviewRevision202606/coreRules.shacl)** — SHACL validation shapes for CDIF Core. 
- **[cdifCore-frame.jsonld](https://github.com/Cross-Domain-Interoperability-Framework/profile-core/blob/reviewRevision202606/cdifCore-frame.jsonld)** — JSON-LD framing to format JSON for schema validation.

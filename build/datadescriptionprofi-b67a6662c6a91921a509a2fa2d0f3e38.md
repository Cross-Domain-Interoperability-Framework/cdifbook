...
- **Obligation:** Optional, Repeatable
- **JSON:** `"@type": ["schema:PropertyValue", "cdi:InstanceVariable"]`
...
- **JSON:** `"@type": ["cdi:ComponentPosition"]`
...
- **JSON:** `"@type": ["cdif:StatisticsCollection"]`
...
- **JSON:** `"@type": ["cdi:CategoryStatistics"]`

...
skos:concept Has more general usage in the Concept Scheme Building block. Skos:prefLabel is required and extends base schema.org verbatim.  The:notation is optional, but its useage is identical to Codelist. 
